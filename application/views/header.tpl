	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><span>PrettyBuys</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="dropmenu" href="#"><i class="{$useraccess->module_icon}"></i><span class="hidden-tablet"> {$useraccess->module_name}</span></a>	
							<ul>
								{foreach from=$useraccess->node item=node}
								<li><a class="submenu" href="{$baseUrl}{$useraccess->module_function}/{$node->node_function}"><i class="{$node->node_icon}"></i><span class="hidden-tablet"> {$node->node_name}</span></a></li>
								{/foreach}
							</ul>
						</li>
						{/foreach}
					...
					<a class="dropmenu" href="#"><i class="icon-shopping-cart"></i><span class="hidden-tablet"> Merchant</span></a>	
							<ul>	
								...
								<li><a class="submenu" href="{$baseUrl}merchant/orders"><i class="icon-gift"></i><span class="hidden-tablet"> Orders</span></a></li>	
